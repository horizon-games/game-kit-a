...
class KhronosTextureContainer {
  static HEADER_LEN: number = 12 + 13 * 4 // identifier + header elements (not including key value meta-data pairs)
  // load types
  static COMPRESSED_2D: number = 0 // uses a gl.compressedTexImage2D()
  static COMPRESSED_3D: number = 1 // uses a gl.compressedTexImage3D()
  static TEX_2D: number = 2 // uses a gl.texImage2D()
  static TEX_3D: number = 3 // uses a gl.texImage3D()
  loadType: number
  glType: number
  glTypeSize: number
  glFormat: number
  ...
  constructor(
    ...
    threeDExpected: boolean = false,
    textureArrayExpected: boolean = false
  ) {
