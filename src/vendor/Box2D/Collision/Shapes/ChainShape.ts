...
export class ChainShape extends Shape {
  ...
  m_vertices: Vec2[] = []
  m_count: number = 0
  readonly m_prevVertex: Vec2 = new Vec2()
  readonly m_nextVertex: Vec2 = new Vec2()
  ...
  ComputeAABB(aabb: AABB, xf: Transform, childIndex: number): void {
    ...
    const vertexi1: Vec2 = this.m_vertices[childIndex]
    const vertexi2: Vec2 = this.m_vertices[(childIndex + 1) % this.m_count]
