...
export class Body {
  ...
  CreateFixture(a: IFixtureDef | Shape, b: number = 0): Fixture {
  ...
  CreateFixtureShapeDensity(shape: Shape, density: number = 0): Fixture {
  ...
  ApplyForce(force: XY, point: XY, wake: boolean = true): void {
  ...
  /// @param force the world force vector, usually in Newtons (N).
  /// @param wake also wake up the body
  ApplyForceToCenter(force: XY, wake: boolean = true): void {
    if (this.m_type !== BodyType.dynamicBody) {
      return
    }
  ...
  /// @param point the world position of the point of application.
  /// @param wake also wake up the body
  ApplyLinearImpulse(impulse: XY, point: XY, wake: boolean = true): void {
    if (this.m_type !== BodyType.dynamicBody) {
      return
    }
  ...
  /// @param impulse the world impulse vector, usually in N-seconds or kg-m/s.
  /// @param wake also wake up the body
  ApplyLinearImpulseToCenter(impulse: XY, wake: boolean = true): void {
    if (this.m_type !== BodyType.dynamicBody) {
      return
    }
