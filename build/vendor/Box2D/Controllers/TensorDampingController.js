 ...
 */
import { Mat22, Max, Vec2 } from '../Common/Math';
...
export class TensorDampingController extends Controller {
    ...
    Step(step) {
        ...
        for (let i = this.m_bodyList; i; i = i.nextBody) {
            ...
            const damping = body.GetWorldVector(Mat22.MulMV(this.T, body.GetLocalVector(body.GetLinearVelocity(), Vec2.s_t0), Vec2.s_t1), TensorDampingController.Step_s_damping);
    ...
    SetAxisAligned(xDamping, yDamping) {
        ...
        this.maxTimestep =
            xDamping > 0 || yDamping > 0
                ? 1 / Max(xDamping, yDamping)
                : (this.maxTimestep = 0);
    }
}
TensorDampingController.Step_s_damping = new Vec2();
// #endif
//# sourceMappingURL=TensorDampingController.js.map