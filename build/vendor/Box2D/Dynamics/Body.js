...
import { Rot, Sweep, Transform, Vec2 } from '../Common/Math';
...
export var BodyType;
(function (BodyType) {
    BodyType[BodyType["unknown"] = -1] = "unknown";
    BodyType[BodyType["staticBody"] = 0] = "staticBody";
    BodyType[BodyType["kinematicBody"] = 1] = "kinematicBody";
    BodyType[BodyType["dynamicBody"] = 2] = "dynamicBody";
    // TODO_ERIN
    // bulletBody = 3
})(BodyType || (BodyType = {}));
...
export class Body {
    ...
    constructor(bd, world) {
        ...
        this.m_xf = new Transform(); // the body origin transform
        // #if ENABLE_PARTICLE
        this.m_xf0 = new Transform();
        // #endif
        this.m_sweep = new Sweep(); // the swept motion for CCD
    ...
    CreateFixtureDef(def) {
        ...
        const fixture = new Fixture(def, this);
        fixture.Create(def);
    ...
    CreateFixtureShapeDensity(shape, density = 0) {
        const def = Body.CreateFixtureShapeDensity_s_def;
        def.shape = shape;
        def.density = density;
    ...
    SetMassData(massData) {
        ...
        Vec2.AddVCrossSV(this.m_linearVelocity, this.m_angularVelocity, Vec2.SubVV(this.m_sweep.c, oldCenter, Vec2.s_t0), this.m_linearVelocity);
    }
    ResetMassData() {
    ...
    GetLinearVelocityFromWorldPoint(worldPoint, out) {
        return Vec2.AddVCrossSV(this.m_linearVelocity, this.m_angularVelocity, Vec2.SubVV(worldPoint, this.m_sweep.c, Vec2.s_t0), out);
    }
...
/// @warning This function is locked during callbacks.
Body.CreateFixtureShapeDensity_s_def = new FixtureDef();
/// Set the mass properties to override the mass properties of the fixtures.
/// Note that this changes the center of mass position.
/// Note that creating or destroying fixtures can also alter the mass.
/// This function has no effect if the body isn't dynamic.
/// @param massData the mass properties.
Body.SetMassData_s_oldCenter = new Vec2();
/// This resets the mass properties to the sum of the mass properties of the fixtures.
/// This normally does not need to be called unless you called SetMassData to override
/// the mass and you later want to reset the mass.
Body.ResetMassData_s_localCenter = new Vec2();
Body.ResetMassData_s_oldCenter = new Vec2();
Body.ResetMassData_s_massData = new MassData();
Body.SynchronizeFixtures_s_xf1 = new Transform();
