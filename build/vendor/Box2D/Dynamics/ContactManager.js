...
export class ContactManager {
    ...
    Collide() {
        ...
        while (c) {
            ...
            const activeA = bodyA.IsAwake() && bodyA.m_type !== BodyType.staticBody;
            const activeB = bodyB.IsAwake() && bodyB.m_type !== BodyType.staticBody;
            ...
            const overlap = TestOverlapAABB(proxyA.aabb, proxyB.aabb);
