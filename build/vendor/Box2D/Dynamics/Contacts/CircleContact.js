...
import { CollideCircles } from '../../Collision/CollideCircle';
...
export class CircleContact extends Contact {
    ...
    Evaluate(manifold, xfA, xfB) {
        ...
        // DEBUG: Assert(shapeA.GetType() === ShapeType.e_circleShape);
        // DEBUG: Assert(shapeB.GetType() === ShapeType.e_circleShape);
        CollideCircles(manifold, shapeA, xfA, shapeB, xfB);
    }
}
//# sourceMappingURL=CircleContact.js.map