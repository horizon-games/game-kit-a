...
export class ContactFilter {
    ...
    ShouldCollide(fixtureA, fixtureB) {
        ...
        if (bodyB.GetType() === BodyType.staticBody &&
...
export class ContactImpulse {
    constructor() {
        this.normalImpulses = MakeNumberArray(maxManifoldPoints);
        this.tangentImpulses = MakeNumberArray(maxManifoldPoints);
        this.count = 0;
    }
}
...
//# sourceMappingURL=WorldCallbacks.js.map