...
export class FrictionJoint extends Joint {
    ...
    SolveVelocityConstraints(data) {
        ...
        // Solve linear friction
        {
            ...
            const Cdot_v2 = Vec2.SubVV(Vec2.AddVCrossSV(vB, wB, this.m_rB, Vec2.s_t0), Vec2.AddVCrossSV(vA, wA, this.m_rA, Vec2.s_t1), FrictionJoint.SolveVelocityConstraints_s_Cdot_v2);
            // Vec2 impulse = -Mul(m_linearMass, Cdot);
            const impulseV = Mat22.MulMV(this.m_linearMass, Cdot_v2, FrictionJoint.SolveVelocityConstraints_s_impulseV).SelfNeg();
            // Vec2 oldImpulse = m_linearImpulse;
            const oldImpulseV = FrictionJoint.SolveVelocityConstraints_s_oldImpulseV.Copy(this.m_linearImpulse);
...
FrictionJoint.SolveVelocityConstraints_s_Cdot_v2 = new Vec2();
FrictionJoint.SolveVelocityConstraints_s_impulseV = new Vec2();
FrictionJoint.SolveVelocityConstraints_s_oldImpulseV = new Vec2();
//# sourceMappingURL=FrictionJoint.js.map