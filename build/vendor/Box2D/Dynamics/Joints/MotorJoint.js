...
import { Clamp, Mat22, Rot, Vec2 } from '../../Common/Math';
import { Maybe } from '../../Common/Settings';
import { Joint, JointDef, JointType } from './Joint';
export class MotorJointDef extends JointDef {
    constructor() {
        super(JointType.e_motorJoint);
        this.linearOffset = new Vec2(0, 0);
...
export class MotorJoint extends Joint {
    ...
    InitVelocityConstraints(data) {
        ...
        const rA = Rot.MulRV(qA, Vec2.SubVV(this.m_linearOffset, this.m_localCenterA, Vec2.s_t0), this.m_rA);
        // this.m_rB = Mul(qB, -this.m_localCenterB);
        const rB = Rot.MulRV(qB, Vec2.NegV(this.m_localCenterB, Vec2.s_t0), this.m_rB);
        ...
        Vec2.SubVV(Vec2.AddVV(cB, rB, Vec2.s_t0), Vec2.AddVV(cA, rA, Vec2.s_t1), this.m_linearError);
    ...
    SolveVelocityConstraints(data) {
        ...
        // Solve linear friction
        {
            ...
            const Cdot_v2 = Vec2.AddVV(Vec2.SubVV(Vec2.AddVV(vB, Vec2.CrossSV(wB, rB, Vec2.s_t0), Vec2.s_t0), Vec2.AddVV(vA, Vec2.CrossSV(wA, rA, Vec2.s_t1), Vec2.s_t1), Vec2.s_t2), Vec2.MulSV(inv_h * this.m_correctionFactor, this.m_linearError, Vec2.s_t3), MotorJoint.SolveVelocityConstraints_s_Cdot_v2);
            // Vec2 impulse = -Mul(this.m_linearMass, Cdot);
            const impulse_v2 = Mat22.MulMV(this.m_linearMass, Cdot_v2, MotorJoint.SolveVelocityConstraints_s_impulse_v2).SelfNeg();
            // Vec2 oldImpulse = this.m_linearImpulse;
            const oldImpulse_v2 = MotorJoint.SolveVelocityConstraints_s_oldImpulse_v2.Copy(this.m_linearImpulse);
...
MotorJoint.SolveVelocityConstraints_s_Cdot_v2 = new Vec2();
MotorJoint.SolveVelocityConstraints_s_impulse_v2 = new Vec2();
MotorJoint.SolveVelocityConstraints_s_oldImpulse_v2 = new Vec2();
//# sourceMappingURL=MotorJoint.js.map