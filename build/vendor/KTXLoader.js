...
class KhronosTextureContainer {
    constructor(arrayBuffer, facesExpected, threeDExpected = false, textureArrayExpected = false) {
        ...
        if (this.numberOfFaces !== facesExpected) {
            console.warn('number of faces expected' +
                facesExpected +
                ', but found ' +
                this.numberOfFaces);
            return;
    ...
    mipmaps(loadMipmaps) {
        ...
        for (let level = 0; level < mipmapCount; level++) {
            ...
            for (let face = 0; face < this.numberOfFaces; face++) {
                const byteArray = new Uint8Array(this.arrayBuffer, dataOffset + 4, imageSize);
